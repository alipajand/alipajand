...
export const PAGE_HEADER_SHELL = `${SECTION_X} border-b border-border bg-background pt-28 pb-10 sm:pb-12 sm:pt-32`;
export const PAGE_MAIN_SHELL = `${SECTION_X} py-24 sm:py-32`;
export const PAGE_ARTICLE_SHELL = `${SECTION_X} py-24 sm:py-28`;
