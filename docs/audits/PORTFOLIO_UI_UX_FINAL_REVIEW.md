...
**Minor (3):**
- m1 — Invalid nested `<li>` in Selected case study badges (introduced, 8) and HiringFit role strip (pre-existing, 4). Fix per A1/V1. *(This is the only objective defect introduced by this change set.)*
