  ...
  return (
    <>
      ...
      <main
        id="main-content"
        tabIndex={-1}
        className="min-h-[60vh] flex flex-col items-center justify-center px-6 py-24 text-center outline-none"
      >
        ...
        <p className="text-muted text-sm max-w-md leading-relaxed mb-10">
          Keyboard tip: focus is moved into this page region automatically so you can tab to the
          actions below.
        </p>
